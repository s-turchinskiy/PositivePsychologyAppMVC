...
(function ($) {
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        ////Turchinskiy 2016-10-27
        //this.$toolbar = $('#RightNavbarGroup');
        ////
        ...
        if (this.options.search) {
            ...
            $('#GroupForSearch').append(html.join(''));
            $search = $('#GroupForSearch').find('.search input');
            //-
