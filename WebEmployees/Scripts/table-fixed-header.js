(function ($) {
    ...
    $.fn.fixedHeader = function (options) {
        ...
        return this.each(function () {
            ...
            $.fn.processScroll = function processScroll() {
                if (!o.is(':visible')) return;
                //$('thead.header')[0].style.background = "#ffff00";
                //$('thead.header-copy')[0].style.background = "#b34e29";

                if ($('thead.header-copy')[0].children.length==2)
                {
                    $('thead.header-copy')[0].children[0].remove();
                }

                if ($('thead.header')[0].children.length == 2) {
                    $('thead.header')[0].children[0].remove();
                }
            ...
            var Html = o.find('thead.header-copy')[0].innerHTML;
